...
const HeroSection: React.FC<FunctionalComponentProps> = ({ id }) => {
  ...
  return (
    ...
    >
      ...
      <motion.div style={{ y: textY }} className="p-10 text-3xl md:text-5xl absolute inset-0 h-screen max-w-2xl text-center m-auto flex flex-col gap-3 items-center justify-center z-10">
        <motion.h1 initial={{
          y: 20,
          opacity: 0
        }}
