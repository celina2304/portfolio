...
const Switch: React.FC = () => (
  <SwitchPrimitive.Root
    defaultChecked
    className="relative inline-flex h-[25px] w-[42px] cursor-pointer items-center rounded-full bg-gray transition-colors duration-200 ease-in-out data-[state=checked]:bg-primary-accent"
  >
