...
const Square: React.FC<ballProps> = (props: ballProps) => {
  const { active, setActive, colIndex, rowIndex, x, y } = props;
...
function Balls() {
  ...
  const animate: CSSVariableProperties = { "--base-hue": 360 };
  const initial: CSSVariableProperties = { "--base-hue": 0 };
